...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "QMCVDevelopment/QMChatViewController/Views/Cells/QMChatContactRequestCell/QMChatContactRequestCell.xib"
  install_resource "QMCVDevelopment/QMChatViewController/Views/Cells/QMChatIncomingCell/QMChatIncomingCell.xib"
  install_resource "QMCVDevelopment/QMChatViewController/Views/Cells/QMChatNotificationCell/QMChatNotificationCell.xib"
  install_resource "QMCVDevelopment/QMChatViewController/Views/Cells/QMChatOutgoingCell/QMChatOutgoingCell.xib"
  install_resource "QMCVDevelopment/QMChatViewController/Views/CustomUI/InputToolBar/QMToolbarContentView.xib"
  install_resource "QMCVDevelopment/QMChatViewController/Views/ReusableViews/LoadEarlierHeaderView/QMLoadEarlierHeaderView.xib"
  install_resource "QMCVDevelopment/QMChatViewController/Views/ReusableViews/TypingIndicatorFooterView/QMTypingIndicatorFooterView.xib"
  install_resource "QMCVDevelopment/QMChatViewController/ChatAssets.xcassets"
